...
//            }
    ...
    fun getNearbySchoolRestaurant(searchText: String, emitter: SingleEmitter<List<RestaurantData>>){
        db.collection(Constants.FIRESTORE_RESTAURANT)
            .whereEqualTo(Constants.SCHOOL_RESTAURANT_FIELD, searchText)
            .get()
            .addOnSuccessListener { result ->
                result
                    .map {
